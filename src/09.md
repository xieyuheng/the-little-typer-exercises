...
function vector_double(
  ...
  let base: (Vector(E, 0)) -> Vector(E, double(0)) = (vector) => Vector.null
...
vector_double(String, 3, Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.null))))
...
vector_twice(String, 3, Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.null))))
```

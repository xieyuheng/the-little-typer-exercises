...
the(Equal(Nat, incr(three), Nat.add1(three)), refl)
...
vector_double(String, three, Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.null))))
...
vector_twice(String, three, Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.null))))
```

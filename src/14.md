...
vector_ref(String, 3, fzero(2), Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.null))))
vector_ref(String, 3, fadd1(2, fzero(1)), Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.null))))
vector_ref(String, 3, fadd1(2, fadd1(1, fzero(0))), Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.null))))
```

...
the(Maybe(Nat), just(Nat, one))
the(Maybe(Nat), just(Nat, two))
the(Maybe(Nat), just(Nat, three))
```
...
list_ref(String, zero, List.cons("a", List.cons("b", List.cons("c", List.null))))
list_ref(String, one, List.cons("a", List.cons("b", List.cons("c", List.null))))
list_ref(String, two, List.cons("a", List.cons("b", List.cons("c", List.null))))
list_ref(String, three, List.cons("a", List.cons("b", List.cons("c", List.null))))
list_ref(String, four, List.cons("a", List.cons("b", List.cons("c", List.null))))
```
...
fadd1(one, fzero(zero))
fadd1(two, fadd1(one, fzero(zero)))
fadd1(three, fadd1(two, fadd1(one, fzero(zero))))
```
...
vector_ref(String, three, fzero(two), Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.null))))
vector_ref(String, three, fadd1(two, fzero(one)), Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.null))))
vector_ref(String, three, fadd1(two, fadd1(one, fzero(zero))), Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.null))))
```
...
// tautologies:
tautology_p(one, (a) => or(a, not(a)))
tautology_p(one, (a) => if(a, a))
tautology_p(three, (a, b, c) => {

...
```cicada
the(Type, Vector(String, zero))
the(Type, Vector(String, one))
the(Type, Vector(List(String), zero))
the(Type, Vector(List(String), one))

the(Vector(String, zero), Vector.null)
the(Vector(List(String), zero), Vector.null)
the(Vector(List(List(String)), zero), Vector.null)

the(Vector(String, one), Vector.cons("a", Vector.null))
the(Vector(String, two), Vector.cons("a", Vector.cons("b", Vector.null)))

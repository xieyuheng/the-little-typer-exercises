...
the(Vector(String, 0), Vector.null)
the(Vector(List(String), 0), Vector.null)
the(Vector(List(List(String)), 0), Vector.null)

the(Vector(String, 1), Vector.cons("a", Vector.null))
the(Vector(String, 2), Vector.cons("a", Vector.cons("b", Vector.null)))

let a: Vector(String, 1) = Vector.cons("a", Vector.null)
let ab: Vector(String, 2) = Vector.cons("a", Vector.cons("b", Vector.null))
let abc: Vector(String, 3) = Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.null)))
let abcd: Vector(String, 4) = Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.cons("d", Vector.null))))
```

...
front(String, zero, Vector.cons("a", Vector.null))
front(String, one, Vector.cons("a", Vector.cons("b", Vector.null)))
front(String, two, Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.null))))
front(String, three, Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.cons("d", Vector.null)))))
```
...
rest(String, zero, Vector.cons("a", Vector.null))
rest(String, one, Vector.cons("a", Vector.cons("b", Vector.null)))
rest(String, two, Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.null))))
rest(String, three, Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.cons("d", Vector.null)))))
```

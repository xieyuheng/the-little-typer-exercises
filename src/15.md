...
function front(E: Type, n: Nat, vector: Vector(E, add1(n))): E {
...
front(String, 0, Vector.cons("a", Vector.null))
front(String, 1, Vector.cons("a", Vector.cons("b", Vector.null)))
front(String, 2, Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.null))))
front(String, 3, Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.cons("d", Vector.null)))))
```

# `rest`

``` cicada
function rest(E: Type, n: Nat, vector: Vector(E, add1(n))): Vector(E, n) {
  function motive(length: Nat, target: Vector(E, length)): Type {
...
rest(String, 0, Vector.cons("a", Vector.null))
rest(String, 1, Vector.cons("a", Vector.cons("b", Vector.null)))
rest(String, 2, Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.null))))
rest(String, 3, Vector.cons("a", Vector.cons("b", Vector.cons("c", Vector.cons("d", Vector.null)))))
```
